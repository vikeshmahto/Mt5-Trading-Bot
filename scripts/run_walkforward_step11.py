"""
scripts/run_walkforward_step11.py
──────────────────────────────────
Executes Step 11: Re-Running the Exact Same Step 7 Pristine Periods with Steps 8–10 Active:
...
log = get_logger("scripts.step11_walkforward")
...
def run_walkforward_slice(
    ...
    log.info("=" * 72)
    log.info(f">>> STEP 11 WALK-FORWARD: {symbol} [{label}] ({start_date} to {end_date})")
    log.info("=" * 72)
    ...
    # Save reports
    reports_dir = Path("reports/walkforward_step11")
    ...
    print("\n" + "=" * 72)
    print(f"STEP 11 WALK-FORWARD REPORT: {symbol} - {label}")
    print("=" * 72)
...
def main():
    test_slices = [
        {
            ...
            "end_date": "2026-02-27",
            "label": "XAUUSD Winter 2025-2026 Walk-Forward (Step 11)",
            "output_prefix": "step11_wf_winter2025_2026",
        },
        {
            "symbol": "BTCUSD",
            "start_date": "2026-03-01",
            "end_date": "2026-05-31",
            "label": "BTCUSD Spring 2026 Walk-Forward (Step 11)",
            "output_prefix": "step11_wf_spring2026",
        },
        {
            "symbol": "EURUSD",
            "start_date": "2026-01-05",
            "end_date": "2026-04-30",
            "label": "EURUSD Q1 2026 Walk-Forward (Step 11)",
            "output_prefix": "step11_wf_q1_2026",
        },
    ]
    ...
    log.info("\n" + "=" * 72)
    log.info("ALL STEP 11 WALK-FORWARD TESTS COMPLETED SUCCESSFULLY!")
    log.info("=" * 72)
